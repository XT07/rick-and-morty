...
function CarregarTodosOsPersonagems(){
  return mock;
}

function listaPersonagem(){
  const todosOsPersonagems = CarregarTodosOsPersonagems()

  return todosOsPersonagems.map(personagem => <div>{ personagem.name }</div>)
}
